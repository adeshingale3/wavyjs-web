...
<p align="center">
  ...
  ·
  <a href="https://www.npmjs.com/package/wavyjs">Package</a>
  ·
...
WavyJS is an open-source UI component package. The package aims to make it easier for designers and developers to incorporate UI components into their projects by providing several official [package](https://www.npmjs.com/package/wavyjs) to make it easier to use these UI Components in your project.
...
WavyJS **does not accept** brand logos, and we do not plan to add them in the future. This is due to a combination of **legal restrictions**, **design consistency concerns**, and **practical maintenance reasons**.
