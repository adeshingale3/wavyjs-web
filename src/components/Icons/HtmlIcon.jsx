...
const HtmlIconInfo = () => {
  ...
  return (
    <div className='text-white flex flex-col ml-5 sm:ml-5 md:ml-30'>
      <h1 className='text-[28px] sm:text-[36px] md:text-[40px] font-bold'>HTML Icon</h1>
      <h4 className='text-gray-500 text-[10px] sm:text-[10px] md:text-[15px]'>An animated HTML Icon to elevate your portfolio or website.</h4>
