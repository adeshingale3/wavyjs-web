...
import { FadingBG, JavaScriptIcon, ReactIcon} from 'wavyjs'
import PropsTable from '../PropTable';

const JavascriptIconInfo = () => {
  const propsData = [
  ...
  return (
    <div className='text-white flex flex-col ml-5 sm:ml-5 md:ml-30'>
      <h1 className='text-[28px] sm:text-[36px] md:text-[40px] font-bold'>JavaScript Icon</h1>
      <h4 className='text-gray-500 text-[10px] sm:text-[10px] md:text-[15px]'>An animated JavaScript Icon to elevate your portfolio or website.</h4>
      ...
      <div className='w-[50vw] h-auto flex flex-col mt-20'>
        ...
        <div className=' flex flex-row justify-between p-4 bg-white/10 rounded-lg h-auto w-[70vw] sm:w-[75vw] md:w-[50vw] mt-4' >
          <h1 className='text-sm sm:text-sm md:text-[16px]' ref={divRef}>
            {"import { JavaSciptIcon } from 'wavyjs'"}
            </h1>
...
export default JavascriptIconInfo