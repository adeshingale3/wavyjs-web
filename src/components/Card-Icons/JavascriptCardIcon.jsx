...
import { JavaIcon, JavascriptCardIcon, ReactCardIcon} from 'wavyjs'

const JavascriptCardIconInfo = () => {
  ...
  return (
    <div className='text-white flex flex-col ml-5 sm:ml-5 md:ml-30'>
      <h1 className='text-[28px] sm:text-[36px] md:text-[40px] font-bold'>React Card Icon</h1>
      <h4 className='text-gray-500 text-[10px] sm:text-[10px] md:text-[15px]'>An animated React Card Icon to elevate your portfolio or website.</h4>
      ...
      <div className='w-[50vw] h-auto flex flex-col mt-20'>
        ...
        <div className=' flex flex-row justify-between p-4 bg-white/10 rounded-lg h-auto w-[70vw] sm:w-[75vw] md:w-[50vw] mt-4' >
          <h1 className='text-sm sm:text-sm md:text-[16px]' ref={divRef}>
            {"import { JavascriptCardIcon } from 'wavyjs'"}
            </h1>
        ...
        <div className=' flex flex-row justify-between p-4 bg-white/10 rounded-lg h-auto w-[70vw] sm:w-[75vw] md:w-[50vw] mt-4' >
          <h1 className='text-sm sm:text-sm md:text-[16px]' ref={divRef}>
            {"<div>"}<br/>
                    {"<JavascriptCardIcon size={300}/>"}<br/>
          {"</div>"}
            </h1>
          <button onClick={handleCopy} className='h-5 text-white bg-white/30 right-0 px-2 py-1 flex items-center rounded-full cursor-pointer text-[12px]'>Copy</button>
        </div>
...
export default JavascriptCardIconInfo