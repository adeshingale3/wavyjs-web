...
import { JavaCardIcon} from 'wavyjs'
import PropsTable from '../PropTable';

const JavaCardIconInfo = () => {
  const propsData = [
  ...
  return (
    <div className='text-white flex flex-col ml-5 sm:ml-5 md:ml-30'>
      <h1 className='text-[28px] sm:text-[36px] md:text-[40px] font-bold'>Java Card Icon</h1>
...
export default JavaCardIconInfo