...
import { BlurredShapesBackground, DarkGridBackground, FadingBG } from 'wavyjs'
...
const DarkGridBGInfo = () => {
    ...
    return (
        <div className='text-white flex flex-col ml-5 sm:ml-5 md:ml-30'>
            <h1 className='text-[28px] sm:text-[36px] md:text-[40px] font-bold'>Grid BG</h1>
            <h4 className='text-gray-500 text-[10px] sm:text-[10px] md:text-[15px]'>A Grid Background for simple websites.</h4>
            <div className='h-[60vh] w-[70vw] sm:w-[75vw] md:w-[50vw] mt-10 py-5'>
                ...
                <div className='h-full w-full mt-5 rounded-lg border-1 border-white/40 flex items-center justify-center'>
                        ...
                        <DarkGridBackground gridColor='#2ce71bff'/>
