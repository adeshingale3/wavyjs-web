...
import { AnimatedDIamond, AnimatedGraphBG } from 'wavyjs'
import PropsTable from '../PropTable';

const AnimatedGraphBGInfo = () => {
  const propsData = [
  {
    "name": "gridSize",
    "type": "number",
    "description": "The spacing (in pixels) between grid lines."
  },
  {
    "name": "strokeWidth",
    "type": "number",
  ...
  },
  {
    "name": "strokeColor",
    "type": "string",
    "description": "The color of the grid lines (hex, rgb, or CSS color)."
  },
  {
    "name": "backgroundColor",
    "type": "string",
    "description": "The background color behind the grid."
  },
  {
    "name": "vignetteColor",
    "type": "string",
    "description": "The color used for vignette shading effect around edges."
  },
  {
    "name": "className",
    "type": "string",
  ...
  },
  {
    "name": "speed",
    "type": "number",
    "description": "The animation speed of the moving grid."
  }
]
  ...
  return (
    <div className='text-white flex flex-col ml-5 sm:ml-5 md:ml-30'>
      <h1 className='text-[28px] sm:text-[36px] md:text-[40px] font-bold'>Animated Graph BG</h1>
        ...
        <div className='flex flex-row justify-between p-4 bg-white/10 rounded-lg w-[70vw] sm:w-[75vw] md:w-[50vw] mt-4'>
          <div className='w-full' ref={divRef}>
            <SyntaxHighlighter language="jsx" style={vscDarkPlus} wrapLongLines customStyle={{ overflowX: "hidden" }}>
              {`import { AnimatedGraph } from 'wavyjs'`}
            </SyntaxHighlighter>
          </div>
...
export default AnimatedGraphBGInfo
