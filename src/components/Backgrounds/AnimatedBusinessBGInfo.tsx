...
const AnimatedBusinessBGInfo = () => {
  ...
  return (
    <div className='text-white flex flex-col ml-5 sm:ml-5 md:ml-30'>
      <h1 className='text-[28px] sm:text-[36px] md:text-[40px] font-bold'>Animated BG</h1>
      ...
      <div className='h-[60vh] w-[70vw] sm:w-[75vw] md:w-[50vw] mt-10 py-5'>
        ...
        <div className='h-full w-full mt-5 rounded-lg border-1 border-white/40'>
          <div className="relative w-full h-full overflow-hidden flex items-center justify-center">
            <AnimatedBusiness />
            <div className="absolute text-black inset-0 flex flex-col items-center justify-center pointer-events-none">
      ...
      <div className='w-[50vw] h-auto flex flex-col mt-20'>
        ...
        <div className='flex flex-row items-center justify-between p-4 bg-white/10 rounded-lg h-15 w-[70vw] sm:w-[75vw] md:w-[50vw] mt-4'>
          ...
          <button
            onClick={handleCopy}
            className='text-white bg-white/30 right-0 px-2 rounded-full cursor-pointer text-[12px]'
          >
            Copy
          </button>
        </div>
        ...
        <div className='flex flex-row justify-between p-4 bg-white/10 rounded-lg h-auto w-[70vw] sm:w-[75vw] md:w-[50vw] mt-4'>
          ...
          <button
            onClick={handleCopy}
            className='h-5 text-white bg-white/30 right-0 px-2 py-1 flex items-center rounded-full cursor-pointer text-[12px]'
          >
            Copy
          </button>
        </div>
...
export default AnimatedBusinessBGInfo
