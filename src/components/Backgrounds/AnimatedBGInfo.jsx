...
import { AnimatedBG, FadingBG} from 'wavyjs'
...
const AnimatedBGInfo = () => {
  ...
  return (
    <div className='text-white flex flex-col ml-5 sm:ml-5 md:ml-30'>
      ...
      <h4 className='text-gray-500 text-[10px] sm:text-[10px] md:text-[15px]'>An animated background for commercial websites.</h4>
