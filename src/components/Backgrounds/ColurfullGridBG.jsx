...
import { BlurredShapesBackground, FadingBG } from 'wavyjs'
...
const ColourfulBGInfo = () => {
    ...
    return (
        <div className='text-white flex flex-col ml-5 sm:ml-5 md:ml-30'>
            <h1 className='text-[28px] sm:text-[36px] md:text-[40px] font-bold'>Colourfull Animated BG</h1>
            <h4 className='text-gray-500 text-[10px] sm:text-[10px] md:text-[15px]'>A background which has animated colorfull shapes.</h4>
